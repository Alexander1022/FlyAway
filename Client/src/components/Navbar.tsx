...
import { Menu, X, LayoutDashboard, Compass, Trophy } from "lucide-react";
...
export default function Navbar() {
  ...
  return (
    <nav className="flex items-center gap-4 md:gap-6 font-['Atkinson Hyperlegible Mono',sans-serif]">
